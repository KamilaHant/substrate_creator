...
class Main {
    ...
    static double[] cell = new double[3]; //matrix for a0, b0, c0 sizes
    static String[] auxiliary; //just an auxiliary array for spliting line
    static double[] angles = new double[3]; //matrix of angles alpha, beta, gamma
    static ArrayList<double[]> coordinates_file = new ArrayList<double[]>(); //coordinates form file
    static String name = "VO2_mp-1102963"; //plain name of the imput/output file
    ...
    /**
     * Recalculate value of angle to radians
     *
     * @param line read line with name and value
    ...
    /**
     * Set name of the element and save coordinates
     *
     * @param line read line with name and value
     * @return 1Darray of name and coordinates
     */
     ...
     * output writer
     *
     * @param final_coordinates array of coordinates which are recalculated
     * @param names             array of names of the elements
     */
    ...
    /**
     * Multiplication af matrixes
     *
     * @param firstMatrix  matrix with coordinates in normal sizes
     * @param secondMatrix matrix of recalculated a0, b0, c0
     * @param row          row of matrix
     * @param col          column of matrix
     * @return value of recalculated coordination of element
     */
...
//recalculation of coordinations
...
//calculation of final coordinates
        ...
        double[][] final_coordinates = new double[(int) (coordinates.length * n1 * n2 * n3)][3]; //in normal space
        double[] names = new double[(int) (coordinates.length * n1 * n2 * n3)]; //names of elements
        int fin_line = 0;

//recalculation for multiplied sizte in normal space (size =1)
